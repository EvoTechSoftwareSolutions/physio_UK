...
<body>
    ...
    <section class="footer--sec1">
        <div class="footer--sec1--div1">
                ...
                <div class="footer--sec1--div4">
                    <div class="footer--sec1--div5">
                        <div class="footer--sec1--div6">
                            <img src="../resources/img/icons/email.png" class="footer--icon">
                        </div>
            ...
            <div class="footer--sec1--div8">
                <span class="footer-heading1">About Us</span>
                <span class="footer-para1">
                    We are a cost effective physiotherapy service which provide the service with most reasonable prices
                    and proven highest standard of treatments.
                </span>
            </div>
        ...
        <div class="footer--sec1--div11">
            ...
            <div class="footer--evotech">
                <span class="#">Design and Developed by <a href="https://evotechsoftwaresolutions.com/"
                        class="footer--name"> &nbsp;EvoTech Software Solutions</a></span>
            </div>
        </div>
    ...
    <section class="footer--sec2">
        ...
        <div class="footer--sec2--div8">
            <div class="footer--sec2--div9">
                <span class="footer-heading1--md">About Us</span>
                <br />
                <span class="footer-para1--md">
                    We are a cost effective physiotherapy service which provide the service with most reasonable prices
                    and proven highest standard of treatments.
                </span>
            </div>
        ...
        <div class="footer--sec2--div17">
            ...
            <div class="footer--evotech--md">
                <span class="#">Design and Developed by <a href="https://evotechsoftwaresolutions.com/"
                        class="footer--name--md"> &nbsp;EvoTech Software Solutions</a></span>
            </div>
        </div>
    ...
    <section class="footer--sec3">
                ...
                <div class="footer--sec3--div5">
                    <div class="footer--sec3--div6">
                        <div class="footer--sec3--div7">
                            <img src="../resources/img/icons/email.png" class="footer--icon--lg">
                        </div>
        ...
        <hr class="footer--sec3--hr">

        <div class="footer--sec3-div9">
            <div class="footer--sec3-div10">
                <span class="footer-heading1--lg">About Us</span>
                <span class="footer-para1--lg">
                    We are a cost effective physiotherapy service which provide the service with most reasonable prices
                    and proven highest standard of treatments.
                </span>
            </div>
        ...
        <div class="footer--sec3--div13">
            ...
            <div class="footer--evotech--lg">
                <span class="#">Design and Developed by <a href="https://evotechsoftwaresolutions.com/"
                        class="footer--name--lg"> &nbsp;EvoTech Software Solutions</a></span>
            </div>
        </div>
