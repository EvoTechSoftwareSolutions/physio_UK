...
<body class="bg-gray-800 font-family-karla flex">
    ...
    ?>
        <div class="overlay-div" id="overlay-div">
        ...
        <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
            ...
            <nav class="text-white text-base font-semibold pt-3">
                ...
                <a href="calendar.php" class="flex items-center active-nav-link text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
        ...
        <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
                <main class="w-full flex-grow p-6">
                    <h1 class="text-3xl text-white pb-6">Calendar</h1>
                                        ...
                                        <div class="-mx-1 -mb-1">
                                            ...
                                            <div class="flex flex-wrap border-t border-l">
                                                ...
                                                <template x-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                                                    <div @click="alertDate(date)" style="width: 14.28%; height: 120px" class="px-4 pt-2 border-r border-b relative hover:bg-blue-200 transition-all">
                                                        <div x-text="date" class="inline-flex w-6 h-6 items-center justify-center cursor-pointer text-center leading-none rounded-full transition ease-in-out duration-100" :class="{'bg-blue-500 text-white': isToday(date) == true, 'text-gray-700 hover:bg-blue-200': isToday(date) == false }">
                                                        </div>
                                                        <div style="height: 80px;" class="overflow-y-auto mt-1">
                                                            <template x-for="event in events.filter(e => new Date(e.event_date).toDateString() ===  new Date(year, month, date).toDateString() )">
                                                                <div class="px-2 py-1 rounded-lg mt-1 overflow-hidden border" :class="{
                                            'border-green-600 text-green-900 bg-green-300': event.event_theme === 'blue',
        ...
        <script>
            ...
            function app() {
                return {
                    ...
                    alertDate(date) {
                        showDateDetails(date, this.month, this.year);
            ...
            function showDateDetails(date, month, year) {
                ...
                r.onreadystatechange = function() {
                    if (r.readyState == 4) {
                        ...
                        if (isValidJSON(r.responseText)) {
                            ...
                            if (jsonObj.status == "success") { // Corrected property name
                        ...
                        Swal.fire({
                            title: `<strong>Appointments ${jsonObj.date}</strong>`,
                            icon: "info",
                            html: content,
                ...
                r.send(`act=getSchedule&date=${date.toString().padStart(2, '0')}-${number.toString().padStart(2, '0')}-${year}`);
            }
            ...
            function generateHTML(data) {
                ...
                data.forEach(record => {
                    htmlString += `
            <div class="w-full border-green-600 text-left mt-1 mb-2 hover:bg-blue-100 cursor-pointer" onclick="singleview(${record.id});">
                    ...
                    r.onreadystatechange = function() {
                        if (r.readyState == 4) {
                            if (isValidJSON(r.responseText)) {
                                ...
                                json.forEach(eve => {
                                    eventArray.push({
                                        event_date: new Date(eve.year, eve.month, eve.day),
                                        event_title: "Booked",
                                        event_theme: 'blue'
                                    });
                                });
