      ...
      <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
          ...
          <div class="navbar-nav w-100">
            ...
            <a href="appointments.php" class="nav-item nav-link active"><i class="fa fa-pen me-2"></i>Appointments</a>
          ...
          <div class="bg-secondary rounded-top p-4">
            <div class="row">
              <div class="col-12 text-center text-sm-start">
                &copy;
                <a href="https://evotechsoftwaresolutions.com">Copyright 2024 @ Evo Tech Software Solutions</a>, All Right Reserved.
              </div>
            </div>
          </div>
        </div>
