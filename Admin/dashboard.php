        ...
        <div class="container-fluid position-relative d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-secondary navbar-dark">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">Hasitha Tharakaa</h6>
                        <span>Admin</span>
                    </div>
                </div> -->
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="mb-0"><?php echo ($accepted->num_rows); ?></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="mb-0"><?php echo ($allAppt->num_rows); ?></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="bg-secondary text-center rounded p-4">
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    <?php
                                    $rs = Database::search("SELECT * FROM `appointment` LIMIT 10");
                                    if ($rs) {
                    ...
                    <div class="bg-secondary rounded-top p-4">
                        <div class="row">
                            <div class="col-12 text-center text-sm-start">
                                &copy; <a href="https://evotechsoftwaresolutions.com">Copyright 2024 @ Evo Tech Software Solutions</a>, All Right Reserved.
                            </div>
                        </div>
                    </div>
                </div>
