            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-secondary navbar-dark">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="history.php" class="nav-item nav-link active"><i
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row vh-100 bg-secondary rounded  justify-content-center mx-0">
                        ...
                        <!-- Appointments History Start -->
                        <div class="container-fluid pt-4 px-4">
                            <div class="bg-secondary text-center rounded p-4">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <h6 class="mb-0 fs-2">Appointments History</h6>
                                    <!-- <a href="">Show All</a> -->
                                </div>
                                <div class="table-responsive">
                                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php
                                            $rs =  Database::search(
                                                "SELECT * FROM `appointment` WHERE (`status_id` = 2 OR `status_id` = 3) ORDER BY `appt_date` DESC;",
                                                "",
                                                ""
                                            );
                                            if ($rs->num_rows > 0) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="w-full py-3 px-4" colspan="4">
